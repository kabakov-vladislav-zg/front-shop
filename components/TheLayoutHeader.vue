<template>
  <header class="the-layout-header navbar py-0 py-lg-2 d-block navbar-dark bg-dark">
    <nav class="container-fluid flex-lg-column align-items-stretch">
      <nuxt-link class="navbar-brand" to="/">Shop</nuxt-link>
      <div class="nav">
        <button
          class="btn the-layout-header__tools the-layout-header__tools_search"
        ></button>
        <button
          class="btn the-layout-header__tools the-layout-header__tools_favorite"
        ></button>
        <button
          class="btn the-layout-header__tools the-layout-header__tools_cart"
        ></button>
        <button
          @click="menu = !menu"
          class="btn the-layout-header__tools the-layout-header__tools_burger d-lg-none"
        ></button>
      </div>
      <transition>
        <div
          v-show="menu"
          class="the-layout-header__menu"
        >
...
.the-layout-header__tools {
  line-height: 0;
}
.the-layout-header__tools_search::before {
...
.the-layout-header__tools_cart::before {
...
.the-layout-header__tools_favorite::before {
...
.the-layout-header__tools_burger::before {
